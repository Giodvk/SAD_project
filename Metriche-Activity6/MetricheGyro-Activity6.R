...
ggplot(media_data, aes(x = Asse, y = Valore, fill = Asse)) +
  geom_boxplot() +
  labs(
    title = "Confronto della media tra giroscopi (Activity 6)",
    x = "Sensore",
    y = "Media"
  ) +
  theme_minimal()
...
ggplot(sd_data, aes(x = Asse, y = Valore, fill = Asse)) +
  geom_boxplot() +
  labs(
    title = "Confronto della deviazione standard tra giroscopi (Activity 6)",
    x = "Sensore",
...
ggplot(skew_data, aes(x = Asse, y = Valore, fill = Asse)) +
  geom_boxplot() +
  labs(
    title = "Confronto della skewness tra giroscopi (Activity 6)",
    x = "Sensore",
    y = "Skewness"
  ) +
  theme_minimal()
