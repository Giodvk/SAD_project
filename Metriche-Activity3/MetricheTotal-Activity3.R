...
ggplot(media_data, aes(x = Asse, y = Valore, fill = Asse)) +
  geom_boxplot() +
  labs(
    title = "Confronto della media tra acc totali(Activity 3)",
    x = "Sensori",
    y = "Media"
  ) +
  theme_minimal()
...
ggplot(sd_data, aes(x = Asse, y = Valore, fill = Asse)) +
  geom_boxplot() +
  labs(
    title = "Confronto della deviazione standard tra acc totali (Activity 3)",
    x = "Sensore",
...
ggplot(skew_data, aes(x = Asse, y = Valore, fill = Asse)) +
  geom_boxplot() +
  labs(
    title = "Confronto della skewness tra acc totali (Activity 3)",
    x = "Sensore",
    y = "Skewness"
  ) +
  theme_minimal()
